...
public class PracticeEntityTest {
    ...
    private MutableLiveData<Practice> currentPractice = new MutableLiveData<>();
    private MutableLiveData<LessonEntity> lessonNoProgress = new MutableLiveData<>();
    ...
    public void loadedPracticeSuccess() {
        LessonEntity lessonEntity = TestUtil.createLesson("en el estudio", "en el estudio");
        this.lessonNoProgress.postValue(lessonEntity);
        setPracticesCodes("show-sign");
        this.currentPractice.postValue(TestUtil.createShowSign(lessonEntity,"A"));
    ...
    public void practiceNoAnswerNoContinue(){
        ...
        this.currentPractice.postValue(TestUtil.createWhichOneVideo(lessonEntity, "A", "B", "C"));
        onView(listMatcher().atPosition(0))
    ...
    public void optionSelectedContinueEnabled(){
        ...
        Practice practice = TestUtil.createWhichOneVideo(lessonEntity, "A", "B", "C");
