...
public class LevelEntitySelectionTest {
    @Rule
    ...
    private MutableLiveData<Resource<List<LevelEntity>>> results = new MutableLiveData<>();
    ...
    public void loadedLevelsSuccess() {
        LevelEntity levelEntity = TestUtil.createLevel("sustantivos", "Sustantivos");
        results.postValue(Resource.success(Arrays.asList(levelEntity)));
