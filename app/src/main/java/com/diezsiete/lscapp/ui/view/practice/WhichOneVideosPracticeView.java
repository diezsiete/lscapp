...
import com.diezsiete.lscapp.ui.adapter.VideoPracticeAdapter;
...
public class WhichOneVideosPracticeView extends BasePracticeView implements WhichOneVideosPracticeContract.SubMvpView {
    @Inject
    WhichOneVideosPracticeContract.Presenter<WhichOneVideosPracticeContract.SubMvpView> mPresenter;
